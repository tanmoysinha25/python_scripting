...
#Script to model MDPE pipe and save the maximum pullout resistance, strain in two seperate .txt files.
        ...
        for q in range (1,Max_iterations):
            ...
            mdb.models['Model-%d' %(q)].keywordBlock.insert(1, 
                '\n*INCLUDE, input=psi_node_Set_Soil5.inp\n*INCLUDE, input=psi_element_Set_Soil5.inp')  #Called for PSI Nodes and Elements (From seperate INP Files)
